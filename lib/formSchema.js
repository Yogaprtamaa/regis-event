...
// Template khusus Bazaar/Tenant — dipakai kalau admin centang "Bazaar"
export const BAZAAR_FORM_SCHEMA = [
  { id: "namaTenant", label: "Nama Tenant / Usaha", type: "text", required: true, placeholder: "Contoh: Kopi Senja" },
  { id: "namaPemilik", label: "Nama Pemilik / Penanggung Jawab", type: "text", required: true, placeholder: "Nama lengkap pemilik" },
  { id: "email", label: "Email", type: "email", required: true, placeholder: "nama@email.com", locked: true },
  { id: "no_wa", label: "Nomor WhatsApp", type: "tel", required: true, placeholder: "081234567890" },
  { id: "kategoriProduk", label: "Kategori Produk", type: "select", required: true, options: ["Kuliner", "Fashion", "Aksesoris", "Jasa / Edukasi", "Lainnya"] },
  { id: "deskripsiProduk", label: "Deskripsi Produk / Jualan", type: "textarea", required: true, placeholder: "Jelaskan produk yang akan dijual di bazaar" },
  { id: "kebutuhanListrik", label: "Kebutuhan Listrik", type: "select", required: false, options: ["Tidak perlu", "Stopkontak standar", "Daya besar (>500W)"] },
  { id: "catatanTambahan", label: "Catatan Tambahan", type: "textarea", required: false, placeholder: "Kebutuhan booth, jam jaga, dll (opsional)" },
];

export const BAZAAR_DEFAULT_PESERTA_CONFIG = { mode: "individu", maxAnggota: 1, nim: "off" };
